function varargout = Acclimate(varargin)
% The following code controls the Acclimate task.
%
% Copyright (c) 2010
% David M. Schneider
% Columbia University
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @Acclimate_OpeningFcn, ...
                   'gui_OutputFcn',  @Acclimate_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function Acclimate_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for Acclimate
...
if handles.startOrStop == 1 && handles.running == 0,
    ...
    while handles.startOrStop == 1,
        ...
        [t response reward punish respCategory tLabels] = AcclimateTrial(handles);
...
% RUN A SINGLE TRIAL
function [t response reward punish respCategory tLabels] = AcclimateTrial(handles)
% Script for running a single Acclimate trial

tcount = 0;

%----------------------------
% ALWAYS REWARD, THIS IS JUST ACCLIMATE
%----------------------------
respCategory = 1;
reward = 1;
punish = 0;
...
function varargout = Acclimate_OutputFcn(hObject, eventdata, handles) 
